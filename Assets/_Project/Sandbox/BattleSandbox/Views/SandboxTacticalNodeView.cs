...
{
    public sealed class SandboxTacticalNodeView : MonoBehaviour
    {
        ...
        public void ApplySnapshot(TacticalNodeSnapshot snapshot)
        {
            ...
            switch (nodeType)
            {
                ...
                case TacticalNodeType.Window:
                case TacticalNodeType.Doorway:
                case TacticalNodeType.BuildingEntrance:
