...
{
    public sealed class M7EnvironmentCombatSandboxBootstrap : MonoBehaviour
    {
        ...
        private M7EnvironmentCombatDebugPanel _debugPanel;
        ...
        public void RebuildScenario()
        {
            ...
            _context.Bind(
                ...
                BattleSandboxScenarioRegistry.GetDisplayName(BattleSandboxMode.M7EnvironmentCombat),
                battleService,
                tacticalCommandService,
                BattleSandboxScenarioRegistry.GetDefaultSelectedSquadId(BattleSandboxMode.M7EnvironmentCombat));
        ...
        private void EnsureComponents()
        {
            ...
            if (_debugPanel == null)
            {
                _debugPanel = GetComponent<M7EnvironmentCombatDebugPanel>();
                if (_debugPanel == null)
                {
                    _debugPanel = gameObject.AddComponent<M7EnvironmentCombatDebugPanel>();
                }
            }
        }
        ...
        {
            if (GameObject.Find("M7SandboxGround") != null)
            {
                return;
            }

            GameObject ground = GameObject.CreatePrimitive(PrimitiveType.Plane);
            ground.name = "M7SandboxGround";
