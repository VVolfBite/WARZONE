...
namespace Warzone.Tests.Combat
{
    public sealed class BattleUnitStateTests
    {
        ...
        public void StatusEffects_StackMoveAndRangeMultipliers()
        {
            ...
            unit.AddStatusEffect(new ActiveStatusEffect(new StatusEffectDefinition("slow", "Slow", 5f, 1f, 0, 0.8f, 1f)));
            unit.AddStatusEffect(new ActiveStatusEffect(new StatusEffectDefinition("aura", "Aura", 5f, 1f, 0, 1f, 0.9f)));
