...
namespace Warzone.UnityAdapters
{
    public static class SandboxSceneInstaller
    {
        ...
        private static void Install()
        {
            ...
            MainMenuScreen mainMenuScreen = EnsureMainMenuScreen();
            ...
            SandboxMenuController menuController = new GameObject("SandboxMenuController").AddComponent<SandboxMenuController>();
            menuController.Configure(battleRuntimeHost, mainMenuScreen, missionStarter, battleBootstrap, debriefScreen);
        }
